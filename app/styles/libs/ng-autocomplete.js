                    ...
                    var newAutocomplete = function () {
                        ...
                        google.maps.event.addListener(scope.gPlace, 'place_changed', function () {
                            scope.$apply(function () {
                                ...
                                location_area1 = scope.gPlace.getPlace().address_components[0].long_name;
                                if (scope.gPlace.getPlace().address_components[1] != undefined) {
                                    location_city1 = scope.gPlace.getPlace().address_components[1].long_name;
                                }
                                location_city = scope.gPlace.getPlace().address_components[0].long_name;
                                lat = scope.gPlace.getPlace().geometry.location.lat();
                                lng = scope.gPlace.getPlace().geometry.location.lng();
                                location_auto = true;
                                scope.action();
                            });
                        })
